...
import model.classifiermodel as classifiermodel
import model.clusteringmodel as clusteringmodel
import model.neuralnetworkmodel as neuralnetworkmodel
    ...
    def optimizeNN(self, x, y, numHiddenFirst, numHiddenSecond, numHiddenThird, epochs, learningRate, k=5, verbose=False):
        ...
        for numFirst, numSecond, numThird in layerPosibilities:
            ...
            for train, test in skfold.split(x, y):
                ffNN = neuralnetworkmodel.FFNN(numInput, numOutput, hidden_size_1=numFirst, hidden_size_2=numSecond, hidden_size_3=numThird, epochs=epochs).to(device)
                xTrain = x[train]
                xTest = x[test]
                yTrain = y[train]
                yTest = y[test]
