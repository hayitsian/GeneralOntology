...
import GOpipeline.model.GIpreprocessing as GIpreprocessing
import model.GIBERTopicModel as GIBERTopicModel
...
def main():
  ...
  _texts = GIpreprocessing.preprocessNgrams(_rawFilename, _columnListNGrams, _indexCol, _dataLabel, _delimiter, _uselessLabel)
  ...
  # BERTopic pipeline
  topic_model = GIBERTopicModel.train(_texts, _embeddingModel = None)
